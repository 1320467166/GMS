...
public class OrderDaoImpl implements OrderDao {
	...
	@Override
	public List<Map<String, Object>> getById(String orderid) throws SQLException {
		QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
		String sql = "select order_user_id from gms_order where order_id = ?";
		return runner.query(sql, new MapListHandler(),orderid);
	}

	@Override
	public List<Map<String, Object>> getPriceById(String orderid) throws SQLException {
		QueryRunner runner = new QueryRunner(DataSourceUtils.getDataSource());
		String sql = "select order_price from gms_order where order_id = ?";
		return runner.query(sql, new MapListHandler(),orderid);
	}
}
