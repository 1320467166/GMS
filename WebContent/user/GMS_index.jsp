...
<body>
	...
	<div class="header">
		<div class="real_header">
			<a href="#" style="text-decoration: none; color: #080b0a;">
				<img src="${pageContext.request.contextPath }/img/indexlogo.png"
				class="head_img" color: >
				<span class="head_span1">体育馆场地管理系统</span>
			</a>
			<div class="login">
				<!-- 用户名为空展示 -->
			...
			<div class="col-lg-12 "
				...
				<div class=" state" style="margin-top: 10px;">
					...
					<div class="sub_for" style="margin-top: -36px;">
						<a style="text-decoration: none; margin-top: 13px; float: right; margin-right: 4px; background-color: #080b0a;"
